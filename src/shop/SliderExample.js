...
let iosStyles = StyleSheet.create({
  track: {
    height: 2,
    borderRadius: 1,
  },
...
let customStyles2 = StyleSheet.create({
  track: {
    height: 4,
    borderRadius: 2,
  },
...
let customStyles3 = StyleSheet.create({
  track: {
    height: 10,
    borderRadius: 5,
...
let customStyles4 = StyleSheet.create({
  track: {
    height: 10,
    borderRadius: 4,
    backgroundColor: 'white',
...
let customStyles5 = StyleSheet.create({
  track: {
    height: 18,
    borderRadius: 1,
...
let customStyles6 = StyleSheet.create({
  track: {
    height: 14,
    borderRadius: 2,
    backgroundColor: 'white',
...
let customStyles7 = StyleSheet.create({
  track: {
    height: 1,
...
let customStyles8 = StyleSheet.create({
  container: {
    height: 30,
  },
  track: {
...
let customStyles9 = StyleSheet.create({
  thumb: {
    width: 30,
    height: 30,
    shadowColor: 'black',
